...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="col-lg-9">
                ...
                <div class="card border-0 bg-light rounded-4 mb-3 shadow-sm">
                    <div class="card-body p-4 p-md-5">
                        <h2 class="fw-bold text-dark mb-4"><asp:Label ID="lblTopicTitle" runat="server"></asp:Label></h2>
                        ...
                        <div class="d-flex align-items-center mb-4 pb-3 border-bottom border-secondary-subtle">
                            ...
                            <div>
                                <h6 class="fw-bold text-dark mb-0"><asp:Label ID="lblAuthorName" runat="server"></asp:Label></h6>
                                <span class="text-muted small"><asp:Label ID="lblPostDate" runat="server"></asp:Label></span>
                            </div>
                        </div>

                        <div class="text-dark" style="line-height: 1.8; white-space: pre-wrap; font-size: 1.05rem;"><asp:Label ID="lblTopicContent" runat="server"></asp:Label></div>
                        </div>
                    </div>
                </div>

                <h5 class="fw-bold text-secondary mb-4 ps-2 border-start border-4 border-primary" >Replies</h5>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <h6 class="fw-bold text-dark mb-0"><%# Eval("Username") %></h6>
                                            <span class="text-muted small" style="font-size: 0.75rem;"><%# Eval("CreatedAt", "{0:MMM dd, yyyy • HH:mm}") %></span>
                                        </div>
                                        <p class="text-dark mb-0" style="white-space: pre-wrap;"><%# Eval("ReplyContent") %></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-5" data-aos="fade-up">
                    ...
                    <asp:Panel ID="pnlLoginPrompt" runat="server" Visible="false">
                        <div class="card border-0 bg-secondary bg-opacity-10 rounded-4 text-center py-5">
                            <h5 class="fw-bold text-dark">Join the Conversation</h5>
                            <p class="text-muted mb-4">You need to be logged in to leave a reply.</p>
                            <div>
                    ...
                    <asp:Panel ID="pnlReplyForm" runat="server" Visible="false">
                        <div class="card shadow-sm border-0 rounded-4">
                            <div class="card-body p-4">
                                <h6 class="fw-bold text-dark mb-3"><i class="bi bi-reply-fill text-primary me-2"></i>Leave a Reply</h6>
                                <asp:Label ID="lblReplyError" runat="server" CssClass="text-danger fw-bold d-block mb-2"></asp:Label>
                                <asp:TextBox ID="txtReplyContent" runat="server" TextMode="MultiLine" Rows="4" CssClass="form-control bg-light border-0 py-3 px-3 mb-3" placeholder="Write your reply here..."></asp:TextBox>
                                <div class="text-end">
    ...
    <style>
        ...
        .form-control { resize: none; transition: all 0.2s ease; }
